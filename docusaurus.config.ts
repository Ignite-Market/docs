...
const config: Config = {
  ...
  organizationName: 'kalmiallc', // Usually your GitHub org/user name.
  projectName: 'ignite-market-docs', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          // editUrl:
          //   'https://github.com/kalmiallc/ignite-market-docs/',
        },
        blog: {
      ...
      links: [
        {
          ...
          items: [
            {
              label: 'Tutorial',
              to: '/docs/docs/introduction/overview',
            },
          ],
        },
        {
