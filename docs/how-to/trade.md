...
Ignite Market uses a prediction-market AMM where you buy and sell outcome shares priced between **0** and **1** collateral token (e.g. USDT0, FXRP). Buying shares is similar to placing a bet: the more likely an outcome, the higher the price.
